...
class SpeechConsumer(ConsumerBase):
    __client__ = None  # type: TextToSpeechClient
    ...
    def consume(self, message: str) -> None:
        self.synthesize_text(message, "output.txt")
        

    def synthesize_text(self, text: str, output_location: str) -> None:
        """Synthesizes speech from the input string of text."""
        SERVICE_ACCOUNT_FILE = 'C:\\Users\\lucas\\Downloads\\twitterreader-1b957530850b.json'
