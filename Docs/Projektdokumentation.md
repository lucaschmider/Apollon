...
Das Gehäuse, welches die verwendete Elektronik beinhaltet, basiert auf dem Model [_Modular Bender Head (Pi Zero Edition)_](https://www.thingiverse.com/thing:4384974) des Nutzers _xbost_ auf Thingiverse. Da der Verwendungszweck dieses Nutzers jedoch von dem in diesem Projekt abweicht, mussten einige Komponenten des Modells überarbeitet werden. Die Explosionsgrafik auf der nächsten Seite zeigt dieses modifizierte Modell.
Das ursprüngliche Modell hatte den Zweck als eine Art _Siri-Pendant_ zu agieren, weshalb in der Antenne ein Mikrofon untergebracht war. Im neuen Modell wurden die verschiedenen Komponenten der Antenne zu einer einzelnen Zusammengefügt. Die Antenne wurde mit einem Langloch versehen und agiert nun als ein Stößel, um den darunterliegenden Taster zu betätigen. Mittels eines Zylinderstiftes wird der Stößel mit der darunter liegenden Antennenführung zu einer Einheit zusammengefasst.  
